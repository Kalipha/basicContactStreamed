...
namespace BasicContactList
{
    internal sealed class ContactManager : IContactManager
    {
        ...
        public void AddContact(string name, string phoneNumber, string? email, ContactType contactType)
        {
            ...
            using (StreamWriter ContactList = new StreamWriter("savedContacts.txt"))
        {
            ...
            ContactList.Write("Contact Type: "+ contactType + "\n");
        ...
        public void GetAllContacts()
        {
          try
            {  
                string savedContacts = "savedContacts.txt";
                using (StreamReader ExistingContact = new StreamReader (savedContacts))
                {
                    while (!ExistingContact.EndOfStream)
                    {
                        string? show = ExistingContact.ReadLine()!;
          ...
          {
            Console.WriteLine("ori e ti daru number no dey this file.");
          }
